  ...
  return (
    <div className="fixed inset-0 bg-black/25 flex items-center justify-center z-[2000] py-5">
      <div
        ...
        className="bg-white overflow-hidden pb-[env(safe-area-inset-bottom,20px)] flex flex-col z-20 w-screen min-h-screen rounded-none xl:w-full xl:max-w-[var(--size-overlay-max)] xl:p-0 xl:min-h-[95vh] xl:h-[95vh] xl:rounded-[32px]"
      >
        <div
