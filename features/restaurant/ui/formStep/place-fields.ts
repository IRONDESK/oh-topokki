...
type FieldName = Path<RestaurantFormData>;
...
export interface SpicyRangeField extends FieldBase {
  type: "spicy-range";
  subField: {
    name: FieldName;
    title: string;
...
export interface TextGroupField extends FieldBase {
  type: "text-group";
  placeholder: string;
}
...
export const placeFields: PlaceField[] = [
  {
    ...
    type: "radio",
    items: [
      { label: "즉석떡볶이", value: "ontable", description: null, icon: null },
  ...
  },
  {
    ...
    type: "checkbox",
    items: [
      { label: "김밥", value: "kimbap", description: null, icon: null },
      {
        label: "꼬마김밥",
        value: "smallkimbap",
        description: null,
      ...
      { label: "국물오뎅", value: "oden", description: null, icon: null },
      { label: "삶은달걀", value: "egg", description: null, icon: null },
      { label: "김말이튀김", value: "kimmari", description: null, icon: null },
      {
        label: "오징어튀김",
        value: "squidfried",
        description: null,
      ...
      { label: "감자튀김", value: "potato", description: null, icon: null },
      {
        label: "고구마튀김",
        value: "sweetpotato",
        description: null,
